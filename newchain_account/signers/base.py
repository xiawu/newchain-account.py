...
class BaseAccount(ABC):
    ...
    def signHash(self, message_hash):
        ...
        This uses the same structure
        as in :meth:`~newchain_account.account.Account.signHash`
        but without specifying the private key.

        .. CAUTION:: Deprecated for :meth:`~newchain_account.signers.base.BaseAccount.sign_message`.
    ...
    def signTransaction(self, transaction_dict):
        ...
        :meth:`~newchain_account.account.Account.sign_transaction`
        but without specifying the private key.

        .. CAUTION:: Deprecated for :meth:`~newchain_account.account.signers.local.sign_transaction`.
